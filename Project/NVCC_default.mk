...
#CXXFLAGS += -Xcompiler -fopenmp -Xcompiler -fmax-errors=1 -Xcompiler -O3
CXXFLAGS += -Xcompiler -fmax-errors=1 -Xcompiler -O3 -I /usr/include/openblas
